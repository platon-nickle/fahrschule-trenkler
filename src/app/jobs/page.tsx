...
export const metadata: Metadata = {
  title: "Jobs | Fahrschule Trenkler",
};
    ...
    <>
      <section className="bg-ink pt-16 pb-24">
        <div className="max-w-container mx-auto px-6">
          <h1 className="text-h1 md:text-h1-md text-white mb-6">Jobs</h1>
      ...
      <section className="py-[120px] bg-white border-b border-divider min-h-[40vh]">
        <div className="max-w-container mx-auto px-6">
          <p className="text-p text-secondary">Inhalt in Vorbereitung. {/* DRAFT: Jobs */}</p>
        </div>
      </section>
      <ClosingCTA />
    </>
